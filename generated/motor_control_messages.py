...
Generated at: 2026-03-06T23:08:19.521683
...
class MotorCommand:
    ...
    _FORMAT: ClassVar[str] = 'ffffiiiififfffffff'
    _SIZE: ClassVar[int] = 72
    ...
    def serialize(self) -> bytes:
        ...
        return struct.pack(self._FORMAT, self.target, self.target_vel, self.kp, self.kd, self.enable_filter, self.switch_, self.calibrate, self.restart, self.timestamp, self.joint_id, *self.latent)
    ...
    def deserialize(cls, data: bytes) -> 'MotorCommand':
        ...
        obj.joint_id = values[9]
        obj.latent = list(values[10:18])
        return obj
...
class SensorData:
    ...
    _FORMAT: ClassVar[str] = 'iiiififfffffiiiifffffffffffffiifffff'
    _SIZE: ClassVar[int] = 144
